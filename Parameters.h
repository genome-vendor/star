...
class Parameters {
    ...
    public:
        ...
        //SAM output
        string outSAMmode, outSAMstrandField,  outSAMunmapped, outSAMorder, outSAMprimaryFlag, outSAMattrRG;
        vector<string> outSAMattributes, outSAMattrRGline, outSAMheaderHD, outSAMheaderPG;
        string outSAMheaderCommentFile;
        int outSAMattrN;
        int outSAMmapqUnique;
        struct {bool NH,HI,AS,NM,MD,nM,jM,jI,RG,XS;} outSAMattrPresent;
        int outSAMattrOrder[ATTR_Nmax];
        int outBAMcompression;
        vector <string> outSAMtype;
        bool outBAMunsorted, outBAMcoord, outBAMbool;
